                ...
                <aside id="categorias-documento" class="widget widget_categories categorias-documento-widget">
                    ...
                    <?php /* ?>
                        ...
                        <ul>
                            ...
                            <li class="cat-item cat-item-1 <?php if (is_post_type_archive('documento')) echo $css_current_cat_class; ?>"><a href="<?php echo get_post_type_archive_link('documento'); ?>"><?php _e('Todos Documentos', 'gpx'); ?></a>
                            </li>
