...
- Go Praxis (Nome do plugin)
- go-praxis (nome dos arquivos, nome do text domain e slug da url do repositório)
- GPX_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Go Praxis, através do próprio sistema de atualizações do WordPress
