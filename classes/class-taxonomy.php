...
class GPX_Taxonomy
{
    ...
    protected function labels()
    {
        $default = array(
            ...
            'add_or_remove_items'        => sprintf(__('Add or Remove %ss', 'go-praxis'), $this->name),
            ...
            'parent_item'                => sprintf(__('Parent %s:', 'go-praxis'), $this->name),
            ...
            'new_item_name'              => sprintf(__('New %s', 'go-praxis'), $this->name),
            'all_items'                  => sprintf(__('All %ss', 'go-praxis'), $this->name),
            'separate_items_with_commas' => sprintf(__('Separate %ss with comma', 'go-praxis'), $this->name),
            'choose_from_most_used'      => sprintf(__('Choose from %ss most used', 'go-praxis'), $this->name)
        );
